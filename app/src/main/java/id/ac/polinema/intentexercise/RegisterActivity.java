...
public class RegisterActivity extends AppCompatActivity {
    ...
    private boolean checkAbout(String about) {
        if(about.isEmpty()){
            AboutText.setError("About is empty");
            return false;
        }else{
            return true;
        }
    ...
    private boolean checkPassword(String password, String confPass) {
        if(password.isEmpty() && confPass.isEmpty()){
            ...
            ConfirmText.setError("Confirmation is empty");
            return false;
    ...
    private boolean checkFullname(String fullname){
        if(fullname.isEmpty()){
            FullText.setError("Please enter your fullname");
            return false;
        }else{
            return true;
        }
    ...
    private boolean checkHomepage(String homepage){
        if(homepage.isEmpty()){
            HomepageText.setError("Please enter your homepage!");
            return false;
        }else if(!Patterns.WEB_URL.matcher(homepage).matches()){
            HomepageText.setError("Please check your homepage!");
            return false;
        }else{
            return true;
        }
